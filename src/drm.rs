...
//! Any card without it — AMD APUs, Intel iGPUs, and Intel discrete cards that
//! don't implement the file — falls back to the shared system-memory ceiling
//! with used/free `None`. NVIDIA cards are skipped here — they're handled by
//! NVML in the `nvidia` module.
